  ...
  return (
    <div className="relative">
      <nav className="bg-green-200 flex items-center justify-evenly h-16">
        <h1 className="text-5xl text-black  tracking-wider font-bold font-serif my-2">
          Ecommerce
        </h1>
        <input
        ...
        <div className="flex gap-x-10">
          ...
          <h1 onClick={openAccount} className="cursor-pointer font-medium tracking-wider text-lg gap-x-1 flex items-center hover:text-green-400">
